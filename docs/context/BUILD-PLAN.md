...
- The authenticated lead-record action opens a lead-specific preparation page, which copies confirmed client details and opens the SignWell template; it does not expose a public self-sign link
