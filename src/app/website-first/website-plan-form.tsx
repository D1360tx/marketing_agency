...
import s from "./website-first.module.css";

export function WebsitePlanForm() {
  const variant = "website-first";
    ...
    try {
      const response = await fetch("/api/leads/inbound", {
        ...
        body: JSON.stringify({ business: value("business"), email: value("email"),
          website: value("website"), businessType: "service business", source: "website-first/v1",
