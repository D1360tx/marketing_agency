...
export default async function DashboardPage() {
  ...
  const [prospectsCountResult, newLeadsCountResult, clientsCountResult, warmLeadsCountResult, campaignsResult, weekActivitiesResult, followUpsTodayResult, sourceDataResult, clientDataResult] =
    await Promise.all([
  ...
  const funnelStatusCounts: Record<string, number> = {
    new: newLeads,
    contacted: (prospectsCountResult.count ?? 0) - newLeads - (warmLeadsCountResult.count ?? 0) - clients,
